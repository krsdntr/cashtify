...
String getChangelogString() {
  return """
    ...
    When tapping support, Castify Pro options highlight
    ...
    < 3.8.0
    Castify pro background now extends past scrollable area - support for (i) over-scroll
    ...
    < 3.7.5
    Castify Pro banner in settings
