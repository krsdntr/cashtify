...
Map<String, String> productIDs = {
  'yearly': getPlatform(ignoreEmulation: true) == PlatformOS.isIOS
      ? 'castify.pro.yearly' //iOS
      : 'castify.pro.yearly', //Android
  'monthly': getPlatform(ignoreEmulation: true) == PlatformOS.isIOS
      ? 'castify.pro.monthly' //iOS
      : 'castify.pro.monthly', //Android
  'lifetime': getPlatform(ignoreEmulation: true) == PlatformOS.isIOS
      ? 'castify.pro.life' //iOS
      : 'castify.pro.lifetime', //Android
};
...
class CastifyProBanner extends StatelessWidget {
  const CastifyProBanner({this.large = false, this.fontColor, super.key});
  final bool large;
      ...
      child: Container(
        ...
        child: Column(
          children: [
            ...
            SizedBox(height: 10),
            CastifyProBanner(fontColor: getColor(context, "black")),
            TextFont(
